...
import env_concave as env

import courants

def iso_point(p, t, dt, n, V, P, C = courants.C2):
...
def iso_suivante(I, t, dt, n, V, P, r):
	L = nuage_iso(I, t, dt, n, V, P)
	return env.enveloppe(L, r)

def n_iso(N, p_dep, t, dt, n, V, P, r):
...
def toutes_iso(p_dep, p_arr, t, dt, n, V, P, e_arr, r):
